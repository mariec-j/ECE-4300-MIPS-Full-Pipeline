...
module Forwardingmux #(parameter WIDTH_inp_forward =  32) (
    ...
    input [(WIDTH_inp_forward-1):0] in_1_forward,
    input [(WIDTH_inp_forward-1):0] in_2_forward,
    input [(WIDTH_inp_forward-1):0] in_3_forward,
    output [(WIDTH_inp_forward-1):0] outp_forward
);
